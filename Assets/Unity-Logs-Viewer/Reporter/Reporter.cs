...
public class Reporter : MonoBehaviour
{
	...
	//public delegate void OnLogHandler( string condition, string stack-trace, LogType t );
	...
	void DrawLogs()
	{
		...
		if (beforeHeight > 0) {
			//fill invisible gap before scroller to make proper scroller p
		...
		if (afterHeight > 0) {
			//fill invisible gap after scroller to make proper scroller p
	...
	//calculate  p of first click on screen
	Vector2 startPos;
